	...
	<div class="container-fluid">
		...
		<div class="card mb-4">
			...
			<div class="mb-3">
				...
				<div class="mb-3">
				<label >Status</label>
				<input class="form-control" type="text" name="role" value="<?=$user->role;?>" Disabled required/>				
			</div>	
			<button class="btn btn-warning" type="submit"><i class="fas fa-edit"></i> Change </button>
			</form>				
</div>
</div>
